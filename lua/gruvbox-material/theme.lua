local material = require("gruvbox-material.colors")
...
theme.loadEditor = function ()
	...
	local editor = {
		...
		CursorColumn =			{ fg = material.none, bg = material.cursor_line_bg },
		CursorLine =			{ fg = material.none, bg = material.cursor_line_bg },
...
theme.loadPlugins = function()
    ...
    local plugins = {
        ...
        IndentBlanklineContextChar =            { fg = material.purple },
