local util = {}
local material = require('gruvbox-material.theme')
...
function util.onColorScheme()
  if vim.g.colors_name ~= "gruvbox-material.nvim" then
...
util.contrast = function ()
    vim.cmd [[augroup Material]]
    vim.cmd [[  autocmd!]]
    vim.cmd [[  autocmd ColorScheme * lua require("gruvbox-material.util").onColorScheme()]]
